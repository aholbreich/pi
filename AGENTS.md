...
This repository uses Task Ledger (`tl`) for local task coordination between humans and agents. Treat TaskLedger as the source of truth for all non-trivial work: planning, claiming, progress notes, blockers, handoffs, and completion.
